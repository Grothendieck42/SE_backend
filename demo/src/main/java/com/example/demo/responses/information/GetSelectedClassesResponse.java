...
import com.example.demo.models.TimeSlotTypeEnum;
...
public class GetSelectedClassesResponse {
    ...
    class ClassSelectedInfo {
        ...
        public void setClaseId(String classId) {
        ...
        public ClassSelectedInfo(String courseId, String courseName, Float credit, String timeSlot, String teacher, String classroom, String classId) {
            this.courseId = courseId;
            this.courseName = courseName;
            this.credit = credit;
            this.timeSlot = timeSlot;
